...
namespace JA.LinearAlgebra
{
        ...
        IFormattable
    {
        ...
        public Matrix3 CrossOp() => LinearAlgebra.CrossOp(this);
        ...
        public static Vector3 FromSpan(Span<double> array, int index)
        {
        ...
        public static Vector3 FromArray(double[] array, int index)
        {
